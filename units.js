	...
	var AllCategoryNUM = {
		"tw": [10, 9, 8, 8, 10, 9, 8, 4, 2, 5, 2, 1],
		"jp": [14, 11, 10, 13, 12, 9, 10, 6, 4, 6, 6, 3]
	};
	...
	function init(state = 0){
		...
		context.fillText("This image was made by mywct.github.io/fgo/", 190 + marginLeft, canvas.height - 25);
	}
